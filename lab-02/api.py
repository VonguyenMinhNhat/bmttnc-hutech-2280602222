...
def playfair_creatematrix():
    data = request.json
    key = data['key']
    playfair_matrix = PlayfairCipher.create_playfair_matrix(key)
...
def playfair_encrypt():
    ...
    key = data['key']
    playfair_matrix = PlayfairCipher.create_playfair_matrix(key)
    encrypted_text = PlayfairCipher.playfair_encrypt(plain_text, playfair_matrix)
    return jsonify({'encrypted_text': encrypted_text})
...
def playfair_decrypt():
    ...
    key = data['key']
    playfair_matrix = PlayfairCipher.create_playfair_matrix(key)
    decrypted_text = PlayfairCipher.playfair_decrypt(cipher_text, playfair_matrix)
    return jsonify({'decrypted_text': decrypted_text})
